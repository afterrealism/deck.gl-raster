...
import { applyAffine, invertGeoTransform } from "./reproject/affine/affine.js";
import type { GeoTIFF, GeoTIFFImage } from "geotiff";
import { type PROJJSONDefinition, createConverter } from "./web-mercator.js";
...
export async function extractGeotiffReprojectors(
  tiff: GeoTIFF,
  _sourceProjection: string | PROJJSONDefinition,
  _outputCrs: string | PROJJSONDefinition = OGC_84,
  ...
  // Since source is always EPSG:3857 and output is usually WGS84
