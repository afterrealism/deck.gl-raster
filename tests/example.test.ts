...
import { RasterReprojector } from "../src/reproject/delatin";
import {
  applyAffine,
  invertGeoTransform,
} from "../src/reproject/affine/affine";
import { createConverter, type PROJJSONDefinition } from "../src/web-mercator";
...
function parseFixture(fixturePath: string): RasterReprojector {
  const { width, height, geotransform, reorderTransform }: FixtureJSON =
  ...
  // Since we only support EPSG:3857, use hardcoded converter
